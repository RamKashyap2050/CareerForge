...
import { Box, FormControl, InputLabel, MenuItem, Select, Typography, Slider } from '@mui/material';
...
const InterviewSettings = () => {
  ...
  const handleLengthChange = (event, newValue) => {
    setInterviewSettings({ ...interviewSettings, length: newValue });
  };

  const handleDifficultyChange = (event, newValue) => {
    setInterviewSettings({ ...interviewSettings, difficulty: newValue });
  };

  const handleStyleChange = (event) => {
    setInterviewSettings({ ...interviewSettings, style: event.target.value });
  };
